...
uses
  ...
  siComp, siLngLnk, IWSiLink, footer_user, baretitle;

type
  TFormVoucherEdit2 = class(TIWAppForm)
    ...
    procedure FormatBoxClick(Sender: TObject);
  private
...
var
  FormVoucherEdit2: TFormVoucherEdit2;

implementation

uses datamod, db, servercontroller, IWInit, Math, cfgtypes, IWTypes, voucherForm, voucherEditForm, imageupform;
...
procedure TFormVoucherEdit2.CancelBtnClick(Sender: TObject);
begin
...
procedure TFormVoucherEdit2.PostButtonClick(Sender: TObject);
var
   s : string;
begin
  try
...
function TFormVoucherEdit2.GetTrigName (ID : Integer; Co : Integer) : String;
begin
...
procedure TFormVoucherEdit2.IWAppFormCreate(Sender: TObject);
...
procedure TFormVoucherEdit2.DrawSelGrid;
var
  i : integer;
  s : string;
begin
...
procedure TFormVoucherEdit2.DrawDepGrid;
var
  i : integer;
begin
  DepGrid.RowCount:=0;
...
procedure TFormVoucherEdit2.DelBtnClick(Sender: TObject);
begin
  with RcDataModule do begin
...
procedure TFormVoucherEdit2.ImageGridRenderCell(ACell: TIWGridCell;
...
procedure TFormVoucherEdit2.MakeLast (id : string);
begin
...
procedure TFormVoucherEdit2.SelGridCellClick(ASender: TObject;const ARow, AColumn: Integer);
var
  i : integer;
begin
...
procedure TFormVoucherEdit2.IWAppFormDestroy(Sender: TObject);
begin
  Alist.free;
  Xlist.free;
  DepGridList.free;
...
procedure TFormVoucherEdit2.IWButton1Click(Sender: TObject);
var
  id : integer;
begin
...
procedure TFormVoucherEdit2.IWButton2Click(Sender: TObject);
begin
...
procedure TFormVoucherEdit2.DepGridCellClick(ASender: TObject;const ARow, AColumn: Integer);
begin
  try
...
procedure TFormVoucherEdit2.AddGrpBtnClick(Sender: TObject);
begin
...
procedure TFormVoucherEdit2.GrpGridCellClick(ASender: TObject; const ARow,
  AColumn: Integer);
begin
  with RcDataModule do begin
...
procedure TFormVoucherEdit2.IWAppFormDefaultAction(Sender: TObject);
begin
   PostButtonClick (Sender);
end;

procedure TFormVoucherEdit2.NewBtnClick(Sender: TObject);
var
  ImageId : integer;
  TFI: TFormImageUp;
begin
  ...
  with RcDataModule.CurrentImageQuery do begin
    ...
    TFI.referedBy:=TFormVoucherEdit2;
    TFI.Show;
  end;
end;
...
procedure TFormVoucherEdit2.PurposeComboChange(Sender: TObject);
var
...
procedure TFormVoucherEdit2.FormatBoxClick(Sender: TObject);
begin
     usersession.NewLayout:=formatbox.checked;
     if not formatbox.checked then begin
        TIWAppForm(WebApplication.ActiveForm).Release;
