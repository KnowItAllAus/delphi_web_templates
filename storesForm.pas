...
begin
  ...
  with StoreGrid do begin
    ...
    if UserSession.Company='0' then begin
        ...
        Cell[0, 1].Text := SiLangLinked1.GetTextOrDefault ('Grid.Id');
        Cell[0, 2].Text := SiLangLinked1.GetTextOrDefault ('Grid.Name');
    ...
    while not RcDataModule.StoreQuery.Eof do begin
      ...
      RowCount:=RowCount+1;
      if (UserSession.Company='0') and false then begin
          with Cell[i, 0] do begin
            Text := RcDataModule.StoreQuery.FieldByName('CoName').AsString;
          end;
